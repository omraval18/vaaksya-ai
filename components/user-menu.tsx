      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size={"icon"}
            className="flex size-7 bg-orange-500 shrink-0 select-none items-center justify-center rounded-full text-xs font-medium uppercase text-primary hover:bg-orange-600 "
          >
            <div>{getUserInitials(user.email)}</div>
          </Button>
        </DropdownMenuTrigger>
